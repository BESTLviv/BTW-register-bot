...
def handle_text_buttons(message):
    ...
    if message_text == "BTW_X_ADMIN228":
        admin_section.send_mailing_menu(user)

    elif message_text == "Розклад":
        bot.send_photo(
            user.chat_id,
            caption="Розклад цьогорічного BTW",
        ...
        bot.send_message(
            user.chat_id,
            text="Звернись до нашого головного організатора @kerril",
            reply_markup=markup,
        )
    ...
    if message_text == "Ірина Клейменова":
        ...
        bot.send_photo(
            ...
            caption="Program manager в українській IT-компанії ELEKS. Автор найбільшого блогу в Україні про project management "
            "<a href='https://t.me/themanagerblog'>Kaizen</a>"
            ". Орест розкаже як починав свій кар’єрний шлях project-менеджера та як досягти успіху в цій сфері. \n"
        ...
        bot.send_photo(
            ...
            caption="Таргетолог-стратег. Запускає рекламу, яка дійсно приносить прибуток. Знімає цікаві відеоуроки по SMM і таргету на "
            "<a href='https://www.youtube.com/channel/UCYXrY_QWuVGwQn5sAhhNwnw'>Youtube</a>"
            ". Співзасновник агентства ADS Wind. Михайло розкаже про професію таргетолога та про роль таргетованої реклами в онлайн-маркетингу. \n"
        ...
        bot.send_photo(
            ...
            caption="Політична журналістка та авторка Telegram-каналу "
            "<a href='https://t.me/mediahospital'>Медіашпиталь</a>"
            ". Працювала на Фактах ICTV редакторкою стрічки новин та аналітикинею у Слово і діло. Нині вона журналістка Бабеля і розкаже вам як це, писати простими словами про складні речі В Telegram \n"
        ...
        bot.send_photo(
            ...
            caption="Громадська діячка. Тренерка soft skills. Організаторка та декораторка подій. Фасилітаторка програми "
            "Активні громадяни"
            " від Британської ради. Менеджерка залучення ресурсів у Львівському обласному молодіжному центрі; Засновниця/голова у ГО "
            "Львівська майстерня організації подій"
            ".\n"
        ...
        bot.send_photo(
            ...
            caption="Дівчина-мандрівниця, яка подолала понад 42 000 км. Розкаже про спільноту "
            "<a href='https://t.me/zlit_dzrhch'>Бакотиків</a>"
            " – групу різних мандрівників та автостоперів, які подорожують Україною. Марго розповість, як подорожувати автостопом та дасть поради. \n"
